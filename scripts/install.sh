#!/bin/sh
# Modificus Curator Linux AppImage installer. This is the recommended Linux
# installer.
#
...
# infers the filename.
#
# The standalone tarball installer (scripts/install-standalone.sh) is unaffected
# and may coexist. The most recently run installer repoints the shared
