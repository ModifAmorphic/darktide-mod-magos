...
/// separately in <c>Magos.Modificus.Integrations.Tests</c>).
/// </remarks>
public sealed class NxmModDownloadHandlerTests
{
    ...
    /// </summary>
    private static NxmModDownloadHandler Build(FakeAcquisitionService bundle, MagosConfig? config = null)
    {
    ...
    private static MagosConfig AuthConfig(NexusAuthMethod method) =>
        new()
        {
            Integrations =
            {
