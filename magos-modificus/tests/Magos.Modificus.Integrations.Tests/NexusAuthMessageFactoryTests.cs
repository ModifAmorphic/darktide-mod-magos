...
public sealed class NexusAuthMessageFactoryTests
{
    ...
    public async Task ApiKeyFactory_adds_apikey_header_and_app_headers()
    {
        ...
        Assert.Equal("Magos-Modificus", request.Headers.GetValues("Application-Name").FirstOrDefault());
        ...
        Assert.Contains("Magos-Modificus", request.Headers.UserAgent.ToString(), StringComparison.Ordinal);
