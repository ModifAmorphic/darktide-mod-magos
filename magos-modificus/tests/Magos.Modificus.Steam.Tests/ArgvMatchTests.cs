...
/// <summary>
/// Unit tests for <see cref="Magos.Modificus.Steam.LinuxProcessLookup.MatchesArgv0"/>.
...
public sealed class ArgvMatchTests
{
    ...
    {
        Assert.Equal(expected, Magos.Modificus.Steam.LinuxProcessLookup.MatchesArgv0(argv0, processName));
    }
}
