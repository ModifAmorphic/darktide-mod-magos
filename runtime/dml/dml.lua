-- dml.lua — Darktide Magos Loader (minimal v1)
...
print("[DML] Darktide Magos Loader v1 — running in engine-context.")
print("[DML] Captured: require=" .. tostring(Mods.original_require)
