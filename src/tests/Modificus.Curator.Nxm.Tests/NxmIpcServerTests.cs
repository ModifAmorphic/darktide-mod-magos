...
/// enforcement is process enumeration before any pipe work (another Curator pid ->
...
public sealed class NxmIpcServerTests
{
    ...
    {
        var pipeName = UniquePipeName();
        // Fake enumerator reports another live Curator pid exists.
    ...
    private static string UniquePipeName() => "curator-nxm-srv-" + Guid.NewGuid().ToString("N");
