#!/usr/bin/env bash
# run_a2_smoke.sh — Phase 3 Tier A2: DLL plumbing smoke test.
#
...
# Phase 3 hook install runs (and either installs or aborts cleanly —
# either is acceptable), the Phase 2b worker thread spawns and runs
# discovery to completion, the log gets the discover summary line, and
...
# Phase 3 hook correctness is covered by run_a1_hook_test.sh.
set -euo pipefail
...
echo
echo "[a2] PASS: Phase 3 plumbing works end-to-end"
